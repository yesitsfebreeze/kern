...
- Module: MCP server surface — tool / prompt / resource handlers exposing kern over MCP (stdio + SSE/HTTP).
- `Server.cache`: semantic cache over answered queries; see `crate::retrieval::cache`.
