...
- Integration tests for KernRpc: end-to-end client/server roundtrip on InprocAdapter + JsonEnvelopeCodec, plus the cancellation race on query.
- link_then_neighbors depth-clamp check: any depth value over 3 should still answer.
