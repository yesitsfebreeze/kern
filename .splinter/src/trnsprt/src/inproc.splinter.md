...
- InProcTransport is a synchronous loopback that runs an McpServer in the caller's thread. TESTS and local-dev only — the buffers are unbounded, no backpressure.
