...
- Module: retrieval pipeline — query text -> ranked entities (+ an optional LLM answer).
- The sibling submodules are the stages of `answer::query`, DELIBERATELY not re-exported at crate level.
