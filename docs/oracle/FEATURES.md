...
(`src/commands/admin.rs:748`) and `maybe_self_heal_store` (`src/commands.rs:446`)
...
| `move` | `tools_mutate.rs:475` | Relocate a thought to another kern, carrying outgoing edges and restamping cross-kern references. |
