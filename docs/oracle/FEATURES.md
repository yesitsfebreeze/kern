...
(`src/commands/admin.rs:785`) and `maybe_self_heal_store` (`src/commands.rs:437`)
...
| `move` | `tools_mutate.rs:473` | Relocate a thought to another kern, carrying outgoing edges and restamping cross-kern references. |
